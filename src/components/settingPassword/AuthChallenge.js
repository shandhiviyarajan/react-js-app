...
import { addAuthChallenge } from '../../actions/authActions';
import TextFieldGroup from '../common/TextFieldGroup';

class AuthChallenge extends Component {
  constructor() {
    super();
    this.state = {
      email: '',
  ...
  onSubmit(e) {
    ...
    const userData = {
      user_id_for_srp: this.props.match.params.id,
      session:localStorage.getItem('Session'),
      newPassword: this.state.password,
      email: this.state.email,
    };

    this.props.addAuthChallenge(userData);
  }
...
AuthChallenge.propTypes = {
  addAuthChallenge: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { addAuthChallenge })(AuthChallenge);
