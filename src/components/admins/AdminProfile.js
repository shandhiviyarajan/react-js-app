  ...
  componentDidMount() {
    axios.post(BASE_URL +"/admin/admin/get-user",{"email": this.props.match.params.id }).then(res => {
      if(res.data.data.Attributes){
        ...
        axios
      .get(BASE_URL_ADMIN+"/user/"+res.data.data.Username,{
          headers:{
          'api-key':'57e989bf-8ddb-4ac8-9db8-820c2aaf48a6',
          'api-secret':'96201083ed8444dbb50bac971fe9ebf1'}
        }).then(res => {this.setState({value: res.data.data.user[0].role_id})
      });
                      ...
                      <form onSubmit={this.onSubmit}>
                          <div className="form-row">
                            <div className="form-group col-md-12">
                              <label htmlFor="feEmail">Role</label>
                              <SelectListGroup
                                placeholder="role"
                                name="roleq"
...
export default connect(
  mapStateToProps,
  { getAdmin, updateAdmin,updateAdminRoleUser }
)(AdminProfile);
