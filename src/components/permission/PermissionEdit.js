...
import { getPermission, updatePermission } from "../../actions/permissionActions";
...
class PermissionEdit extends Component {
  ...
  componentDidMount() {
    ...
    axios.get(BASE_URL_ADMIN +"/permission/"+this.props.match.params.id,
    {
        headers:{
        ...
        'api-secret':'96201083ed8444dbb50bac971fe9ebf1'}
            ...
            this.setState({
              name: res.data.data.permissions[0][0].name,
              description: res.data.data.permissions[0][0].description,
              category: res.data.data.permissions[0][0].category,
            });
      });
  }
  ...
  onSubmit(e) {
    ...
    this.props.updatePermission(this.props.match.params.id, permissionData, this.props.history);
  }
        ...
        <div className="col-lg-12">
          <div className="mb-4 card card-small">
            <div className="border-bottom card-header">
              <h6 className="m-0">Update Permission</h6></div>
